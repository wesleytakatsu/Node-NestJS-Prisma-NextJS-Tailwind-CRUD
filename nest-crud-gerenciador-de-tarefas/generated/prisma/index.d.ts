...
export namespace Prisma {
  ...
  */
  ...
  export type TarefaOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "description" | "completed" | "userId" | "createdAt" | "updatedAt", ExtArgs["result"]["tarefa"]>
  ...
  interface TarefaFieldRefs {
    ...
    readonly completed: FieldRef<"Tarefa", 'Boolean'>
  ...
  export type TarefaWhereInput = {
    ...
    completed?: BoolFilter<"Tarefa"> | boolean
  ...
  export type TarefaScalarWhereWithAggregatesInput = {
    ...
    completed?: BoolWithAggregatesFilter<"Tarefa"> | boolean
